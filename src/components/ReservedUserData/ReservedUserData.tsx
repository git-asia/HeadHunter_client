  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      const student = data.data.map((item =>(
          ...
          ],id:item.studentId, name: item.firstName+' '+item.lastName, githubUsername: item.githubUsername, reservationExpiresOn:item.reservationExpiresOn, open: false}
             ...
             <div className="input-container">
               ...
               />
                 ...
                 <input
                     type="button"
                     value="Zatrudniony"
                     onClick={() => changeStatus(item.id,index,'employ')}
                 />
               <IoIosArrowDown
                   size={30}
                   fill="#666666"
